...
│       ↕                                             │
│   Fluss Gateway (:8080)  ← OpenClaw connects       │
│       ↕                                             │
...
| Fluss Coordinator | 9123 | 内部元数据服务 |
| Fluss Tablet Server | 9124 | 数据读写服务 |
| Fluss Gateway | 8080 | REST API (OpenClaw 连接此端口) |
...
- Fluss Gateway REST API: `http://<HOST_IP>:8080/health`
